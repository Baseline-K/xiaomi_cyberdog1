...
/* DEBUG_OUT stub — replace with your own printf/log implementation if needed */
#ifndef DEBUG_OUT
...
float Current_PLL_filter(PLL_t *PLL_Filter, float eleAngle_input,float eleAngle_input_b, float eleAngle_input_c)
{
  ...
  Limit_Sat(PLL_Filter->PLL_Omega ,PLL_Filter -> PLL_Omega_Maxlimit, PLL_Filter -> PLL_Omega_Minlimit);
	PLL_Filter->PLL_Theta += (PLL_Filter->PLL_Omega* PLL_Filter -> OmegaToTheta);
			...
			static float eleangle_Sinx_b = 0;
			static float eleangle_Cosx_b	= 0;
			static float PLLangle_Sinx_b = 0;
			static float PLLangle_Cosx_b	= 0;
			static float PLL_DeltTheta_Sum_b = 0, PLL_Omega_b = 0, PLL_Theta_b = 0;
		
			static float eleangle_Sinx_c = 0;
			static float eleangle_Cosx_c	= 0;
			static float PLLangle_Sinx_c = 0;
			static float PLLangle_Cosx_c	= 0;
			static float PLL_DeltTheta_Sum_c = 0, PLL_Omega_c = 0, PLL_Theta_c = 0;
		...
		PLL_Omega_b = (PLL_Filter -> SpeedPllKp * PLL_Filter->PLL_DeltTheta) + \
	                            (PLL_Filter -> SpeedPllKi * PLL_DeltTheta_Sum_b);
		 	PLL_Omega_c = (PLL_Filter -> SpeedPllKp * PLL_Filter->PLL_DeltTheta) + \
	                            (PLL_Filter -> SpeedPllKi * PLL_DeltTheta_Sum_c);
...
//   SP_SOGI_PLL_update(&Ia_PLL_SOGI, ia, &ia_test);
  ia_test = Current_PLL_filter(PhaseA_PLL_currentFilter, ia, 0, 0);
	return 0;
}

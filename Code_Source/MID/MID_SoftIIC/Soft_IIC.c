...
//#include "i2c.h"  // HAL I2C not used; project uses software I2C only
...
/* GD32_PATCH: Use CubeMX-configured IIC pins from main.h (PC4=SCL, PA5=SDA) */
#include "main.h"
#define SOFT_SCL_PORT (IIC_SCL_GPIO_Port)
#define SOFT_SCL_PIN  (IIC_SCL_Pin)
#define SOFT_SDA_PORT (IIC_SDA_GPIO_Port)
#define SOFT_SDA_PIN  (IIC_SDA_Pin)
...
{
    // HAL I2C not used; software I2C only

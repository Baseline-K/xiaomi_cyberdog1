...
HAL_StatusTypeDef HAL_CAN_Init(CAN_HandleTypeDef *hcan)
{
  ...
  /* GD32F303 fix: exit sleep mode before requesting init.
     On GD32 CAN peripheral, SLEEP must be cleared first,
     otherwise INAK will never be asserted after INITRQ. */
